...
import org.uoc.pds.alpha.cultureindahouse.ejb.bean.CategoryRemote;
...
public class CategoryRMIClient {
	...
	protected void run() throws NamingException {
		...
		CategoryRemote beanRemote = (CategoryRemote) ctx.lookup("java:pra2-ear/pra2-ejb/CategoryBean!org.uoc.pds.alpha.cultureindahouse.ejb.bean.CategoryRemote");
